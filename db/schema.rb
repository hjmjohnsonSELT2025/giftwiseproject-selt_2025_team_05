...
ActiveRecord::Schema[7.1].define(version: 2025_11_11_025001) do
  ...
  create_table "eventsgifts", force: :cascade do |t|
    t.integer "gifts_id"
    t.integer "events_id"
    t.index ["events_id"], name: "index_eventsgifts_on_events_id"
    t.index ["gifts_id"], name: "index_eventsgifts_on_gifts_id"
  end
